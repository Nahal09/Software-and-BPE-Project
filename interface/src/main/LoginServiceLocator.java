...
public class LoginServiceLocator extends org.apache.axis.client.Service implements main.LoginService {
    ...
    private java.lang.String Login_address = "http://localhost:8080/Project/services/Login";
    ...
    public main.Login getLogin() throws javax.xml.rpc.ServiceException {
    ...
    public main.Login getLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main.LoginSoapBindingStub _stub = new main.LoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main.Login.class.isAssignableFrom(serviceEndpointInterface)) {
                main.LoginSoapBindingStub _stub = new main.LoginSoapBindingStub(new java.net.URL(Login_address), this);
                _stub.setPortName(getLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://main", "LoginService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://main", "Login"));
        }
